        ...
        <v-navigation-drawer v-model="drawer" :mini-variant="miniVariant" :clipped="clipped" fixed app>
            <v-list>
                <div v-for="(item, i) in navs" :key="i">
                    <v-list-group no-action v-if="item.children" :prepend-icon="item.icon" value="true">
                    ...
                    <v-list-item v-else @click="$router.push(localePath(item.to, locale))">
                        <v-list-item-icon>
            ...
            <v-menu offset-y>
                ...
                <v-list>
                    <v-list-item v-for="(item, index) in listLocales" :key="index">
                        <v-btn small text @click="switchLocale(item)">{{ item }}</v-btn>
                    </v-list-item>
                </v-list>
            </v-menu>
        </v-app-bar>
